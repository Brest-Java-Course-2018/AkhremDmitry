...
public class DepartmentDaoImpl implements DepartmentDao{
    ...
    private final String GET_DEPARTMENTS_SQL = "SELECT departmentId, departmentName, description " +
            "FROM department";
    private final String GET_DEPARTMENTS_BY_ID_SQL = "SELECT departmentId, departmentName, description " +
    ...
    public Department getDepartmentById(int departmentId) {
        ...
        Department department = namedParameterJdbcTemplate.queryForObject(GET_DEPARTMENTS_BY_ID_SQL, namedParameters, new DepartmentRowMapper());
        return department;
    }
